export const Cards = [
  ...
  },
  {
    ...
    value: "star",
    value_int: 17,
    meaning_up: "Loss, theft, privation, abandonment.",
  ...
  },
  {
    ...
    meaning_rev:
      "Less Material happiness, less fortunate marriage, less contentment.",
    type: "major",
  },
  {
    ...
    value: "last-judgment",
    value_int: 20,
    meaning_up: "Change of position, renewal, outcome.",
    meaning_rev:
  ...
  },
  {
    ...
    name_short: "wapa",
    suit: "wands",
    meaning_up: "A faithful postman. Family intelligence. ",
    meaning_rev:
      "Anecdotes, announcements, evil news. Indecision and instability.",
    type: "minor",
  ...
  },
  {
    ...
    name_short: "wakn",
    suit: "wands",
    meaning_up: "Departure, absence, flight, emigration. Change of residence.",
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "A countrywoman, friendly, chaste, loving, honourable. Love of money, or a certain success in business.",
    meaning_rev:
      "Good, economical, obliging, serviceable. Opposition, jealousy, even deceit and infidelity.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "A countryman, generally married, honest and conscientious. Honesty, an unexpected inheritance.",
  ...
  },
  {
    ...
    name_short: "waac",
    suit: "wands",
    meaning_up: "Creation, invention, enterprise, principle, beginning, money.",
    meaning_rev:
      "Fall, decadence, ruin, perdition, also perhaps a certain clouded joy.",
    type: "minor",
  ...
  },
  {
    ...
    name_short: "wa02",
    suit: "wands",
    meaning_up: "Riches, fortune, magnificence",
  ...
  },
  {
    ...
    name_short: "wa03",
    suit: "wands",
    meaning_up: "Strength, enterprise, effort, trade, commerce, discovery.",
    meaning_rev:
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "Country life, haven of refuge, domestic harvest-home, repose, concord, harmony, prosperity, peace.",
    meaning_rev: "Prosperity, increase, felicity, beauty, embellishment.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "Imitation, a sham fight, strenuous competition and struggle for riches.",
  ...
  },
  {
    ...
    name_short: "wa06",
    suit: "wands",
    meaning_up: "A victor triumphing, great news, the crown of hope. ",
    meaning_rev:
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "Valor, discussion, wordy strife; in business--negotiations, war of trade, barter, competition.",
    meaning_rev:
      "Perplexity, embarrassments, anxiety. A caution against indecision.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "Strength in opposition. If attacked, the person will meet an onslaught boldly.",
  ...
  },
  {
    ...
    suit: "wands",
    meaning_up:
      "Fortune, gain, any kind of success, but also false-seeming and loss.",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "A fair young man, a studious youth; news, message; application, reflection, meditation.",
    meaning_rev:
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Good, fair woman; honest, devoted woman, loving intelligence, the gift of vision; success, happiness, pleasure.",
    meaning_rev:
      "A distinguished woman but one not to be trusted; perverse woman; vice, dishonour, depravity.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Fair man, man of business, law, or divinity; responsible, equity, art and science, creative intelligence. ",
    meaning_rev:
  ...
  },
  {
    ...
    name_short: "cuac",
    suit: "cups",
    meaning_up: "Joy, content, abode, nourishment, abundance, fertility.",
    meaning_rev: "False heart, mutation, instability, revolution.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Perfection and merriment; happy issue, victory, fulfilment, solace, healing,",
    meaning_rev:
      "Expedition, dispatch, achievement, end. Excess in physical enjoyment.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Weariness, disgust, aversion, imaginary vexations, blended pleasure.",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Inheritance, patrimony, transmission,marriage, but not without bitterness or frustration. ",
    meaning_rev:
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Nostalgia, happiness, enjoyment from the past; things that have vanished.",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Contemplation, but nothing permanent or substantial is suggested.",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Giving joy, mildness, timidity, honour, modesty. Decline of a matter.",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Concord, contentment, physical well-being; also victory, success, advantage.",
    meaning_rev: "Truth, loyalty, liberty; also mistakes, imperfections.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "cups",
    meaning_up:
      "Contentment, repose of the entire heart; the perfection of that state.",
  ...
  },
  {
    ...
    name_short: "pepa",
    suit: "pentacles",
    meaning_up: "Application, study, scholarship, reflection.",
    meaning_rev:
  ...
  },
  {
    ...
    suit: "pentacles",
    meaning_up:
      "Money, business, barter; but can lead to altercation and quarrels. ",
    meaning_rev:
      "Cause for anxiety regarding money which you may be proposed to lend.",
    type: "minor",
  ...
  },
  {
    ...
    meaning_rev:
      "Voided ambition, vanity, cupidity, exaction, usury. Possession of skill; the ingenious mind turned to cunning and intrigue.",
    type: "minor",
  ...
  },
  {
    ...
    meaning_rev: "The unforeseen, unprepared state; sickness.",
    type: "minor",
  ...
  },
  {
    ...
    name_short: "swki",
    suit: "swords",
    meaning_up: "Power, command, authority, militant intelligence, law.",
  ...
  },
  {
    ...
    suit: "swords",
    meaning_up:
      "Triumph, conquest, triumph of force in love as well as in hatred. ",
    meaning_rev: "Conception, childbirth, augmentation, multiplicity.",
    type: "minor",
  ...
  },
  {
    ...
    suit: "swords",
    meaning_up:
      "Conformity, courage, friendship, concord, tenderness, affection, intimacy.",
  ...
  },
  {
    ...
    meaning_rev: "Declaration, confession, publicity; A proposal of love.",
    type: "minor",
